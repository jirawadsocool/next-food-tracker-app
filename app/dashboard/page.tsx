...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-4 sm:mb-0">Dashboard</h1>
          <div className="flex items-center space-x-4">
            ...
            <button className="bg-purple-500 text-white font-bold py-3 px-6 rounded-full shadow-lg transform transition-transform duration-300 hover:scale-105 hover:bg-purple-600 focus:outline-none focus:ring-4 focus:ring-purple-500 focus:ring-opacity-50">
              Logout
            </button>
          </div>
        </div>
